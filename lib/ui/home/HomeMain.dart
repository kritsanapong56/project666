...
class _HomeMainState extends State<HomeMain> {
  ...
  List<ModelMedicine> listMedicine = [
    ModelMedicine(id: 1, name: 'แก้ภูมแพ้',dateTime: DateTime.now(),messageDateTime: "ไม่ได้ทานยา"),
  ];
            ...
            Expanded(
              child:  GroupListView(
                ...
                itemBuilder: (BuildContext context, IndexPath index) {
                  var num_eat = resultAlarmMedicine.values.toList()[index.section][index.index].msg_skip;
                  return
                  ...
                  Card(
                      ...
                      child: InkWell(
                        onTap: () {},
                        child: ListTile(
                          leading: resultAlarmMedicine.values.toList()[index.section][index.index].img_medicine.isNotEmpty ?
                          Image.network(resultAlarmMedicine.values.toList()[index.section][index.index].img_medicine) :
                          ImageIcon(
